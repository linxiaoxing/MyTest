...
class QuestionPageState extends State<QuestionPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return new MaterialApp(
      ...
      home: new Scaffold(
        appBar: new AppBar(
          title: null//Common.searchInput(context),
        ),
        body: new SingleChildScrollView(
          child: new Column(
            children: <Widget>[
              ...
              new Container(
                child: new Text("《三体》里的水滴有可能被制造出来吗?", style: new TextStyle(fontWeight: FontWeight.bold,
                    fontSize: 18.0, height: 1.3, color: GlobalConfig.dark == true ? Colors.white70 : Colors.black)),
                padding: new EdgeInsets.only(left: 16.0, bottom: 8.0, right: 16.0),
                alignment: Alignment.topLeft,//Aligment.topLeft,
                color: GlobalConfig.cardBackgroundColor,
              ),
              new Container(
                child: new Text(
