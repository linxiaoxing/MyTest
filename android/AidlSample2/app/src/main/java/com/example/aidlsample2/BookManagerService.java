...
public class BookManagerService extends Service{
    ...
    private RemoteCallbackList<com.example.aidlsample2.IOnNewBookArrivedListener> mListenerList = new RemoteCallbackList<>();
    private AtomicBoolean mIsServiceDestroyed = new AtomicBoolean(false);

    private Binder mBinder = new com.example.aidlsample2.IBookManager.Stub() {
        ...
        @Override
        public void registerListener(com.example.aidlsample2.IOnNewBookArrivedListener listener) throws RemoteException {
        ...
        @Override
        public void unregisterListener(com.example.aidlsample2.IOnNewBookArrivedListener listener) throws RemoteException {
    ...
    private void onNewBookArrived(Book book) throws RemoteException {
        ...
        int num = mListenerList.beginBroadcast();
        for (int i = 0; i < num; ++i) {
            com.example.aidlsample2.IOnNewBookArrivedListener listener = mListenerList.getBroadcastItem(i);
