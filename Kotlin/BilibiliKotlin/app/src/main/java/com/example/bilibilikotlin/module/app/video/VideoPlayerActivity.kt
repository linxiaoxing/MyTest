...
import com.example.bilibilikotlin.media.MediaController
import com.example.bilibilikotlin.media.VideoPlayerView
import com.example.bilibilikotlin.media.callback.DanmukuSwitchListener
import com.example.bilibilikotlin.media.callback.VideoBackListener
...
class VideoPlayerActivity : BaseInjectActivity<VideoPlayerPresenter>(), DanmukuSwitchListener,
    VideoBackListener, VideoPlayerContract.View {
    ...
    override fun showVideoPlayer(videoPlayer: VideoPlayer) {
        ...
        val uri1 = "http://f.youku.com/player/getFlvPath/sid/138035737110468_00/st/flv/fileid/03000201004F97EF4A2E350467A09DB266E872-5522-225F-DC45-40B4E1F9BE49?K=c2a4327df2bb5a65261d40ea"
        ...
        palyer_view.setVideoURI(Uri.parse(uri1))
