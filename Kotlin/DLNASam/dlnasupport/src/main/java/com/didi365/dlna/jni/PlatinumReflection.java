...
public class PlatinumReflection {
    ...
    /*----------------------------------------------------------------*/
    public static final String RENDERER_TOCONTRPOINT_CMD_INTENT_NAME="com.pngcui.platinum.tocontrolpointer.cmd.intent";
    ...
    public static void setActionInvokeListener(PlatinumReflection.ActionReflectionListener listener){
        mListener = listener;
    }
}
